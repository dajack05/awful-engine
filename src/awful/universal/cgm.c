...
float cgm_clamp(float v, float min, float max) {
  return v > max ? max : (v >= min ? v : min);
}
float cgm_lerp(float from, float to, float t) { return (to - from) * t + from; }
float cgm_lerp_inv(float from, float to, float value) {
  return (value - from) / (to - from);
}
float cgm_cubic_bezier_curve_interp_1d(CgmVec2 start_anchor, CgmVec2 end_anchor,
                                       float ratio) {
  CgmVec2 pts[] = {
...
float cgm_remap(float from_value, float from_min, float from_max, float to_min,
                float to_max) {
...
CgmF16 CgmF16_from_float(float v) {
  if (isinf(v))
    return (CgmF16){.bits = v < 0.0 ? 0xfc00 : 0x7c00};
  if (isnan(v))
    return (CgmF16){.bits = 0xffff};
...
CgmVec2 CgmVec2_copysign(CgmVec2 v, CgmVec2 copy) {
  return CgmVec2_init(copysignf(v.x, copy.x), copysignf(v.y, copy.y));
}

CgmVec2 CgmVec2_add(CgmVec2 a, CgmVec2 b) {
  return CgmVec2_init(a.x + b.x, a.y + b.y);
}
...
CgmVec2 CgmVec2_add_scalar(CgmVec2 v, float by) {
  return CgmVec2_init(v.x + by, v.y + by);
}
...
float CgmVec2_angle(CgmVec2 v) { return atan2f(-v.y, v.x); }
...
CgmVec2 CgmVec2_reflect(CgmVec2 v, CgmVec2 normal) {
  return CgmVec2_sub(v,
                     CgmVec2_mul_scalar(normal, 2.0 * CgmVec2_dot(v, normal)));
}
...
CgmVec2 CgmVec2_rotate(CgmVec2 v, float angle) {
  float co = cosf(angle);
  float si = sinf(angle);
  return CgmVec2_init((v.x * si) - (v.y * co), (v.x * co) + (v.y * si));
}
...
CgmVec2 CgmVec2_min(CgmVec2 a, CgmVec2 b) {
  return CgmVec2_init(cgm_min(a.x, b.x), cgm_min(a.y, b.y));
}
CgmVec2 CgmVec2_max(CgmVec2 a, CgmVec2 b) {
  return CgmVec2_init(cgm_max(a.x, b.x), cgm_max(a.y, b.y));
}
CgmVec2 CgmVec2_clamp(CgmVec2 v, CgmVec2 min, CgmVec2 max) {
  return CgmVec2_init(cgm_clamp(v.x, min.x, max.x),
                      cgm_clamp(v.y, min.y, max.y));
}
...
CgmVec2 CgmVec2_round_to_multiple(CgmVec2 v, CgmVec2 multiple) {
  return CgmVec2_init(cgm_round_to_multiple(v.x, multiple.x),
                      cgm_round_to_multiple(v.y, multiple.y));
}
CgmVec2 CgmVec2_round_up_to_multiple(CgmVec2 v, CgmVec2 multiple) {
  return CgmVec2_init(cgm_round_up_to_multiple(v.x, multiple.x),
                      cgm_round_up_to_multiple(v.y, multiple.y));
}
CgmVec2 CgmVec2_round_down_to_multiple(CgmVec2 v, CgmVec2 multiple) {
  return CgmVec2_init(cgm_round_down_to_multiple(v.x, multiple.x),
                      cgm_round_down_to_multiple(v.y, multiple.y));
}
CgmVec2 CgmVec2_abs(CgmVec2 v) { return CgmVec2_init(fabs(v.x), fabs(v.y)); }
CgmVec2 CgmVec2_floor(CgmVec2 v) {
  return CgmVec2_init(floorf(v.x), floorf(v.y));
}
CgmVec2 CgmVec2_ceil(CgmVec2 v) { return CgmVec2_init(ceilf(v.x), ceilf(v.y)); }
CgmVec2 CgmVec2_round(CgmVec2 v) {
  return CgmVec2_init(roundf(v.x), roundf(v.y));
}
CgmBool CgmVec2_approx_eq(CgmVec2 a, CgmVec2 b) {
  return cgm_approx_eq(a.x, b.x) && cgm_approx_eq(a.y, b.y);
}
...
CgmVec3 CgmVec3_copysign(CgmVec3 v, CgmVec3 copy) {
  return CgmVec3_init(copysignf(v.x, copy.x), copysignf(v.y, copy.y),
                      copysignf(v.z, copy.z));
}

CgmVec3 CgmVec3_add(CgmVec3 a, CgmVec3 b) {
  return CgmVec3_init(a.x + b.x, a.y + b.y, a.z + b.z);
}
...
CgmVec3 CgmVec3_add_scalar(CgmVec3 v, float by) {
  return CgmVec3_init(v.x + by, v.y + by, v.z + by);
}
...
CgmVec3 CgmVec3_mul_cross(CgmVec3 a, CgmVec3 b) {
  return CgmVec3_init(a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z,
                      a.x * b.y - a.y * b.x);
}

CgmVec3 CgmVec3_reflect(CgmVec3 v, CgmVec3 normal) {
  return CgmVec3_sub(v,
                     CgmVec3_mul_scalar(normal, 2.0 * CgmVec3_dot(v, normal)));
}
...
CgmVec3 CgmVec3_rotate(CgmVec3 point, CgmVec3 rotation_vector, float angle) {
  ...
  CgmVec3 vec =
      CgmVec3_add(CgmVec3_add(CgmVec3_mul_scalar(rotation_vector_norm, comp),
...
CgmVec3 CgmVec3_perp_backward(CgmVec3 v) {
  return CgmVec3_init(v.x, -v.z, v.y);
}

CgmVec3 CgmVec3_min(CgmVec3 a, CgmVec3 b) {
  return CgmVec3_init(cgm_min(a.x, b.x), cgm_min(a.y, b.y), cgm_min(a.z, b.z));
}
CgmVec3 CgmVec3_max(CgmVec3 a, CgmVec3 b) {
  return CgmVec3_init(cgm_max(a.x, b.x), cgm_max(a.y, b.y), cgm_max(a.z, b.z));
}
CgmVec3 CgmVec3_clamp(CgmVec3 v, CgmVec3 min, CgmVec3 max) {
  return CgmVec3_init(cgm_clamp(v.x, min.x, max.x),
                      cgm_clamp(v.y, min.y, max.y),
                      cgm_clamp(v.z, min.z, max.z));
}
CgmVec3 CgmVec3_lerp(CgmVec3 from, CgmVec3 to, CgmVec3 t) {
  return CgmVec3_init(cgm_lerp(from.x, to.x, t.x), cgm_lerp(from.y, to.y, t.y),
                      cgm_lerp(from.z, to.z, t.z));
}
...
CgmVec3 CgmVec3_round_to_multiple(CgmVec3 v, CgmVec3 multiple) {
  return CgmVec3_init(cgm_round_to_multiple(v.x, multiple.x),
                      cgm_round_to_multiple(v.y, multiple.y),
                      cgm_round_to_multiple(v.z, multiple.z));
}
CgmVec3 CgmVec3_round_up_to_multiple(CgmVec3 v, CgmVec3 multiple) {
  return CgmVec3_init(cgm_round_up_to_multiple(v.x, multiple.x),
                      cgm_round_up_to_multiple(v.y, multiple.y),
                      cgm_round_up_to_multiple(v.z, multiple.z));
}
CgmVec3 CgmVec3_round_down_to_multiple(CgmVec3 v, CgmVec3 multiple) {
  return CgmVec3_init(cgm_round_down_to_multiple(v.x, multiple.x),
                      cgm_round_down_to_multiple(v.y, multiple.y),
                      cgm_round_down_to_multiple(v.z, multiple.z));
}
CgmVec3 CgmVec3_abs(CgmVec3 v) {
  return CgmVec3_init(fabs(v.x), fabs(v.y), fabs(v.z));
}
CgmVec3 CgmVec3_floor(CgmVec3 v) {
  return CgmVec3_init(floorf(v.x), floorf(v.y), floorf(v.z));
}
CgmVec3 CgmVec3_ceil(CgmVec3 v) {
  return CgmVec3_init(ceilf(v.x), ceilf(v.y), ceilf(v.z));
}
CgmVec3 CgmVec3_round(CgmVec3 v) {
  return CgmVec3_init(roundf(v.x), roundf(v.y), roundf(v.z));
}
CgmBool CgmVec3_approx_eq(CgmVec3 a, CgmVec3 b) {
  return cgm_approx_eq(a.x, b.x) && cgm_approx_eq(a.y, b.y) &&
         cgm_approx_eq(a.z, b.z);
}

CgmBool CgmVec4_eq(CgmVec4 a, CgmVec4 b) {
  return a.x == b.x && a.y == b.y && a.z == b.z && a.w == b.w;
}
CgmVec4 CgmVec4_copysign(CgmVec4 v, CgmVec4 copy) {
  return CgmVec4_init(copysignf(v.x, copy.x), copysignf(v.y, copy.y),
                      copysignf(v.z, copy.z), copysignf(v.w, copy.w));
}
...
CgmVec3 CgmMat3x2_column(CgmMat3x2 *m, uint32_t column_idx) {
  return CgmVec3_init(m->row[0].a[column_idx], m->row[1].a[column_idx],
                      m->row[2].a[column_idx]);
}

void CgmMat3x2_mul(CgmMat3x2 *out, CgmMat3x2 *a, CgmMat3x2 *b) {
  out->row[0] =
      CgmVec2_init((a->row[0].x * b->row[0].x) + (a->row[0].y * b->row[1].x),
                   (a->row[0].x * b->row[0].y) + (a->row[0].y * b->row[1].y));

  out->row[1] =
      CgmVec2_init((a->row[1].x * b->row[0].x) + (a->row[1].y * b->row[1].x),
...
CgmVec2 CgmMat3x2_mul_point(CgmMat3x2 *m, CgmVec2 pt) {
  return CgmVec2_init((pt.x * m->row[0].x) + (pt.y * m->row[1].x) + m->row[2].x,
                      (pt.x * m->row[0].y) + (pt.y * m->row[1].y) +
                          m->row[2].y);
}

CgmVec2 CgmMat3x2_mul_vector(CgmMat3x2 *m, CgmVec2 v) {
  return CgmVec2_init((v.x * m->row[0].x) + (v.y * m->row[1].x),
...
void CgmMat4x4_identity_rotate(CgmMat4x4 *out, CgmVec3 v, float angle) {
  ...
  out->row[0] = CgmVec4_init(1.0 - (2.0 * (yy + zz) * sq),
                             2.0 * ((v.x * v.y * sq) - (v.z * sc)),
                             2.0 * ((v.x * v.z * sq) + (v.y * sc)), 0.0);

  out->row[1] = CgmVec4_init(2.0 * ((v.x * v.y * sq) + (v.z * sc)),
                             1.0 - (2.0 * (xx + zz) * sq),
                             2.0 * ((v.y * v.z * sq) - (v.x * sc)), 0.0);

  out->row[2] = CgmVec4_init(2.0 * ((v.x * v.z * sq) - (v.y * sc)),
                             2.0 * ((v.y * v.z * sq) + (v.x * sc)),
                             1.0 - (2.0 * (xx + yy) * sq), 0.0);
...
CgmVec4 CgmMat4x4_column(CgmMat4x4 *m, uint32_t column_idx) {
  return CgmVec4_init(m->row[0].a[column_idx], m->row[1].a[column_idx],
                      m->row[2].a[column_idx], m->row[3].a[column_idx]);
}

void CgmMat4x4_ortho(CgmMat4x4 *out, float left, float right, float bottom,
...
void CgmMat4x4_perspective(CgmMat4x4 *out, float fovy, float aspect_ratio,
...
void CgmMat4x4_mul(CgmMat4x4 *out, CgmMat4x4 *a, CgmMat4x4 *b) {
  out->row[0] =
      CgmVec4_init(a->row[0].x * b->row[0].x + a->row[0].y * b->row[1].x +
                       a->row[0].z * b->row[2].x + a->row[0].w * b->row[3].x,
                   a->row[0].x * b->row[0].y + a->row[0].y * b->row[1].y +
                       a->row[0].z * b->row[2].y + a->row[0].w * b->row[3].y,
                   a->row[0].x * b->row[0].z + a->row[0].y * b->row[1].z +
                       a->row[0].z * b->row[2].z + a->row[0].w * b->row[3].z,
                   a->row[0].x * b->row[0].w + a->row[0].y * b->row[1].w +
                       a->row[0].z * b->row[2].w + a->row[0].w * b->row[3].w);

  out->row[1] =
      CgmVec4_init(a->row[1].x * b->row[0].x + a->row[1].y * b->row[1].x +
                       a->row[1].z * b->row[2].x + a->row[1].w * b->row[3].x,
                   a->row[1].x * b->row[0].y + a->row[1].y * b->row[1].y +
                       a->row[1].z * b->row[2].y + a->row[1].w * b->row[3].y,
                   a->row[1].x * b->row[0].z + a->row[1].y * b->row[1].z +
                       a->row[1].z * b->row[2].z + a->row[1].w * b->row[3].z,
                   a->row[1].x * b->row[0].w + a->row[1].y * b->row[1].w +
                       a->row[1].z * b->row[2].w + a->row[1].w * b->row[3].w);

  out->row[2] =
      CgmVec4_init(a->row[2].x * b->row[0].x + a->row[2].y * b->row[1].x +
                       a->row[2].z * b->row[2].x + a->row[2].w * b->row[3].x,
                   a->row[2].x * b->row[0].y + a->row[2].y * b->row[1].y +
                       a->row[2].z * b->row[2].y + a->row[2].w * b->row[3].y,
                   a->row[2].x * b->row[0].z + a->row[2].y * b->row[1].z +
                       a->row[2].z * b->row[2].z + a->row[2].w * b->row[3].z,
                   a->row[2].x * b->row[0].w + a->row[2].y * b->row[1].w +
                       a->row[2].z * b->row[2].w + a->row[2].w * b->row[3].w);

  out->row[3] =
      CgmVec4_init(a->row[3].x * b->row[0].x + a->row[3].y * b->row[1].x +
                       a->row[3].z * b->row[2].x + a->row[3].w * b->row[3].x,
                   a->row[3].x * b->row[0].y + a->row[3].y * b->row[1].y +
                       a->row[3].z * b->row[2].y + a->row[3].w * b->row[3].y,
                   a->row[3].x * b->row[0].z + a->row[3].y * b->row[1].z +
                       a->row[3].z * b->row[2].z + a->row[3].w * b->row[3].z,
                   a->row[3].x * b->row[0].w + a->row[3].y * b->row[1].w +
                       a->row[3].z * b->row[2].w + a->row[3].w * b->row[3].w);
}

CgmVec3 CgmMat4x4_mul_point(CgmMat4x4 *m, CgmVec3 pt) {
  return CgmVec3_init((pt.x * m->row[0].x) + (pt.y * m->row[1].x) +
                          (pt.z * m->row[2].x) + m->row[3].x,
                      (pt.x * m->row[0].y) + (pt.y * m->row[1].y) +
                          (pt.z * m->row[2].y) + m->row[3].y,
                      (pt.x * m->row[0].z) + (pt.y * m->row[1].z) +
                          (pt.z * m->row[2].z) + m->row[3].z);
}

CgmVec4 CgmMat4x4_mul_point4(CgmMat4x4 *m, CgmVec4 pt) {
  return CgmVec4_init((pt.x * m->row[0].x) + (pt.y * m->row[1].x) +
                          (pt.z * m->row[2].x) + m->row[3].x,
                      (pt.x * m->row[0].y) + (pt.y * m->row[1].y) +
                          (pt.z * m->row[2].y) + m->row[3].y,
                      (pt.x * m->row[0].z) + (pt.y * m->row[1].z) +
                          (pt.z * m->row[2].z) + m->row[3].z,
                      (pt.x * m->row[0].w) + (pt.y * m->row[1].w) +
                          (pt.z * m->row[2].w) + m->row[3].w);
}
...
CgmVec2 CgmAabb2d_top_right(CgmAabb2d *a) { return CgmVec2_init(a->ex, a->y); }

CgmVec2 CgmAabb2d_bottom_left(CgmAabb2d *a) {
  return CgmVec2_init(a->x, a->ey);
}

float CgmAabb2d_width(CgmAabb2d *a) { return a->ex - a->x; }

float CgmAabb2d_height(CgmAabb2d *a) { return a->ey - a->y; }

CgmVec2 CgmAabb2d_size(CgmAabb2d *a) { return CgmVec2_sub(a->max, a->min); }
...
CgmBool cgm_2d_ray_vs_aabb(CgmRay2d *r, float r_max_distance, CgmAabb2d *a,
                           CgmVec2 *contact_normal_out,
                           float *contact_distance_out) {
...
CgmBool cgm_2d_swept_aabb_vs_aabb(CgmAabb2d *a, CgmVec2 a_dir,
                                  float a_max_distance, CgmAabb2d *b,
                                  CgmVec2 *contact_normal_out,
                                  float *contact_distance_out) {
  if (a_dir.x == 0 && a_dir.y == 0) {
    return cgm_false;
  }
  ...
  return cgm_2d_ray_vs_aabb(&ray, a_max_distance, &tmp, contact_normal_out,
                            contact_distance_out);
}

CgmBool cgm_2d_aabb_vs_swept_aabb(CgmAabb2d *a, CgmAabb2d *b, CgmVec2 b_dir,
                                  float b_max_distance,
                                  CgmVec2 *contact_normal_out,
                                  float *contact_distance_out) {
  if (b_dir.x == 0 && b_dir.y == 0) {
    return cgm_false;
  }
  ...
  return cgm_2d_ray_vs_aabb(&ray, b_max_distance, &tmp, contact_normal_out,
                            contact_distance_out);
}

CgmBool cgm_2d_swept_aabb_vs_swept_aabb(CgmAabb2d *a, CgmVec2 a_dir,
                                        float a_distance, CgmAabb2d *b,
                                        CgmVec2 b_dir, float b_distance,
                                        CgmVec2 *contact_normal_out,
                                        float *contact_distance_out) {
  return cgm_2d_swept_aabb_vs_aabb(a, CgmVec2_sub(b_dir, a_dir),
                                   b_distance - a_distance, b,
                                   contact_normal_out, contact_distance_out);
}

CgmBool cgm_2d_aabb_vs_aabb(CgmAabb2d *a, CgmAabb2d *b,
                            CgmVec2 *contact_normal_out,
                            float *contact_distance_out) {
  CgmAabb2d tmp = *b;
  CgmVec2 a_half_size = CgmAabb2d_half_size(a);
  ...
  return cgm_2d_aabb_vs_pt(&tmp, CgmAabb2d_center(a), contact_normal_out,
                           contact_distance_out);
}

CgmBool cgm_2d_aabb_vs_pt(CgmAabb2d *a, CgmVec2 pt, CgmVec2 *contact_normal_out,
                          float *contact_distance_out) {
  ...
  if (relative_pt.x < relative_pt.y) {
    if (contact_distance_out)
      *contact_distance_out = relative_pt.x;
    if (contact_normal_out)
      *contact_normal_out = CgmVec2_init(copysignf(1.0, vec.x), 0.0);
  } else {
    if (contact_distance_out)
      *contact_distance_out = relative_pt.y;
    if (contact_normal_out)
      *contact_normal_out = CgmVec2_init(0.0, copysignf(1.0, vec.y));
  }
...
CgmVec3 CgmRay3d_get_projected_pt(CgmRay3d *ray, float ray_max_contact_distance,
                                  CgmVec3 pt) {
...
CgmVec3 CgmAabb3d_size(CgmAabb3d *a) {
  return CgmVec3_init(a->ex - a->x, a->ey - a->y, a->ez - a->z);
}
CgmVec3 CgmAabb3d_half_size(CgmAabb3d *a) {
  return CgmVec3_mul_scalar(CgmAabb3d_size(a), 0.5f);
}
CgmVec3 CgmAabb3d_center(CgmAabb3d *a) {
  return CgmVec3_add(a->min, CgmVec3_mul_scalar(CgmAabb3d_size(a), 0.5f));
}
CgmVec3 CgmAabb3d_clamp_pt(CgmAabb3d *a, CgmVec3 pt) {
  return CgmVec3_clamp(pt, a->min, a->max);
}
...
CgmVec3 CgmAabb3d_closest_pt_on_ray(CgmAabb3d *a, CgmVec3 origin,
                                    CgmVec3 direction, float min, float max) {
  CgmVec3 vertices[] = {
      CgmVec3_init(a->x, a->y, a->z),   CgmVec3_init(a->ex, a->y, a->z),
      CgmVec3_init(a->x, a->ey, a->z),  CgmVec3_init(a->x, a->y, a->ez),
      CgmVec3_init(a->ex, a->ey, a->z), CgmVec3_init(a->x, a->ey, a->ez),
      CgmVec3_init(a->ex, a->y, a->ez), CgmVec3_init(a->ex, a->ey, a->ez),
  };
  ...
  for (uint32_t i = 0; i < 8; i += 1) {
    ...
    CgmVec3 perp_pt =
        CgmVec3_add(origin, CgmVec3_mul_scalar(direction, offset_to_perp_pt));
...
CgmVec3 CgmAabb3d_closest_pt_along_ray(CgmAabb3d *a, CgmVec3 origin,
                                       CgmVec3 direction, float min,
                                       float max) {
  CgmVec3 vertices[] = {
      CgmVec3_init(a->x, a->y, a->z),   CgmVec3_init(a->ex, a->y, a->z),
      CgmVec3_init(a->x, a->ey, a->z),  CgmVec3_init(a->x, a->y, a->ez),
...
CgmVec3 CgmCapsule3d_get_projected_pt(CgmCapsule3d *capsule, CgmVec3 pt) {
  ...
  return CgmVec3_add(capsule->center_pos,
                     CgmVec3_mul_scalar(capsule->direction, offset));
}

void CgmTriangle3d_aabb(CgmTriangle3d *triangle, CgmAabb3d *aabb_in_out) {
  aabb_in_out->x =
      cgm_min(triangle->a.x, cgm_min(triangle->b.x, triangle->c.x));
  aabb_in_out->ex =
      cgm_max(triangle->a.x, cgm_max(triangle->b.x, triangle->c.x));
  aabb_in_out->y =
      cgm_min(triangle->a.y, cgm_min(triangle->b.y, triangle->c.y));
  aabb_in_out->ey =
      cgm_max(triangle->a.y, cgm_max(triangle->b.y, triangle->c.y));
  aabb_in_out->z =
      cgm_min(triangle->a.z, cgm_min(triangle->b.z, triangle->c.z));
  aabb_in_out->ez =
      cgm_max(triangle->a.z, cgm_max(triangle->b.z, triangle->c.z));
}
...
CgmVec3 CgmHoop3d_closest_pt(CgmHoop3d *hoop, CgmVec3 pt) {
  ...
  CgmVec3 up_vec = CgmVec3_mul_scalar(
      hoop->up, CgmVec3_dot(hoop->up, hoop_center_to_pt_vec));
  CgmVec3 right_vec = CgmVec3_mul_scalar(
      hoop->right, CgmVec3_dot(hoop->right, hoop_center_to_pt_vec));
  ...
  CgmVec3 vec_to_closest_pt_on_hoop =
      CgmVec3_mul_scalar(inner_vec_norm, radius_to_nearest_pt);
...
void CgmHoop3d_aabb(CgmHoop3d *hoop, CgmAabb3d *aabb_in_out) {
  ...
  CgmVec3 hoop_face_normal =
      CgmVec3_norm(CgmVec3_mul_cross(hoop->up, hoop->right));
  CgmVec3 normal_offset =
      CgmVec3_mul_scalar(hoop_face_normal, hoop->rim_radius);
  CgmVec3 normal_start = CgmVec3_add(hoop->center_pos, normal_offset);
  CgmVec3 normal_end =
      CgmVec3_add(hoop->center_pos, CgmVec3_neg(normal_offset));
...
CgmBool cgm_3d_pt_vs_aabb(CgmVec3 pt, CgmAabb3d *aabb,
                          CgmVec3 *contact_normal_out,
                          float *contact_distance_out) {
  CgmVec3 vec = CgmVec3_sub(pt, CgmAabb3d_center(aabb));
  CgmVec3 relative_pt =
      CgmVec3_sub(CgmAabb3d_half_size(aabb), CgmVec3_abs(vec));
  ...
  if (relative_pt.x < relative_pt.y && relative_pt.x < relative_pt.z) {
    if (contact_distance_out)
      *contact_distance_out = relative_pt.x;
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_init(-copysignf(1.0, vec.x), 0.f, 0.f);
  } else if (relative_pt.y < relative_pt.x && relative_pt.y < relative_pt.z) {
    if (contact_distance_out)
      *contact_distance_out = relative_pt.y;
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_init(0.0, -copysignf(1.0, vec.y), 0.f);
  } else {
    if (contact_distance_out)
      *contact_distance_out = relative_pt.z;
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_init(0.0, 0.f, -copysignf(1.0, vec.z));
  }

  return cgm_true;
}

CgmBool cgm_3d_pt_vs_sphere(CgmVec3 pt, CgmSphere *sphere,
                            CgmVec3 *contact_normal_out,
                            float *contact_distance_out) {
  ...
  if (vec_len_squared <= radius_squared) {
    ...
    if (contact_distance_out)
      *contact_distance_out = sphere->radius - distance;
    if (contact_normal_out) {
      if (distance == 0.f)
        *contact_normal_out = CgmVec3_init(0.f, 0.f, 1.f);
      else {
        // CgmVec3_norm(vec)
...
CgmBool cgm_3d_pt_vs_capsule(CgmVec3 pt, CgmCapsule3d *capsule,
                             CgmVec3 *contact_normal_out,
                             float *contact_distance_out) {
  CgmVec3 vec_to_pt = CgmVec3_sub(pt, capsule->center_pos);
  float offset = CgmVec3_dot(capsule->direction, vec_to_pt);
  ...
  CgmVec3 projected_pt = CgmVec3_add(
      capsule->center_pos, CgmVec3_mul_scalar(capsule->direction, offset));

  CgmSphere sphere = {.radius = capsule->radius, .center_pos = projected_pt};
  return cgm_3d_pt_vs_sphere(pt, &sphere, contact_normal_out,
                             contact_distance_out);
}

CgmBool cgm_3d_ray_vs_aabb(CgmRay3d *r, float r_max_distance, CgmAabb3d *a,
                           CgmVec3 *contact_normal_out,
                           float *contact_distance_out) {
  float tx1 = (a->x - r->pos.x) / r->dir.x;
  float tx2 = (a->ex - r->pos.x) / r->dir.x;
...
CgmBool cgm_3d_ray_vs_sphere(CgmRay3d *ray, float ray_max_contact_distance,
                             CgmSphere *sphere, CgmVec3 *contact_normal_out,
                             float *contact_distance_out) {
  CgmVec3 ray_to_sphere_vec = CgmVec3_sub(
      sphere->center_pos,
      ray->pos); // this is the vector from ray->pos to sphere->center_pos
  float ray_to_sphere_vec_squared_distance =
      CgmVec3_dot(ray_to_sphere_vec, ray_to_sphere_vec);
  float sphere_radius_squared = sphere->radius * sphere->radius;
  if (CgmVec3_dot(ray_to_sphere_vec, ray->dir) <
      0) { // the sphere is behind the origin ray->pos
    if (ray_to_sphere_vec_squared_distance > sphere_radius_squared) {
      ...
      if (contact_distance_out)
        *contact_distance_out = 0.f;
      if (contact_normal_out)
        *contact_normal_out =
            CgmVec3_norm(CgmVec3_sub(ray->pos, sphere->center_pos));
    } else {
      // occurs when ray->pos is inside the sphere
      if (isinf(ray_max_contact_distance) && !contact_normal_out &&
          !contact_distance_out)
        return cgm_true;

      CgmVec3 closest_pt_on_ray = CgmRay3d_get_projected_pt(
          ray, ray_max_contact_distance, sphere->center_pos);
      CgmVec3 vec_sphere_to_closest_pt_on_ray =
          CgmVec3_sub(closest_pt_on_ray, sphere->center_pos);
      float vec_sphere_to_closest_pt_on_ray_squared_distance = CgmVec3_dot(
          vec_sphere_to_closest_pt_on_ray, vec_sphere_to_closest_pt_on_ray);
      // distance to the closest hit on the sphere
      float distance_to_closest_hit =
          sqrtf(sphere_radius_squared -
                vec_sphere_to_closest_pt_on_ray_squared_distance);
      CgmVec3 vec_ray_to_closest_pt_on_ray =
          CgmVec3_sub(closest_pt_on_ray, ray->pos);
      distance_to_closest_hit -= CgmVec3_len(vec_ray_to_closest_pt_on_ray);
      if (distance_to_closest_hit > ray_max_contact_distance)
        return cgm_false;

      if (contact_distance_out)
        *contact_distance_out = distance_to_closest_hit;
      if (contact_normal_out)
        *contact_normal_out = CgmVec3_norm(CgmVec3_sub(
            CgmVec3_add(ray->pos,
                        CgmVec3_mul_scalar(ray->dir, distance_to_closest_hit)),
            sphere->center_pos));
    }
  } else {
    CgmVec3 closest_pt_on_ray = CgmRay3d_get_projected_pt(
        ray, ray_max_contact_distance, sphere->center_pos);
    CgmVec3 vec_sphere_to_closest_pt =
        CgmVec3_sub(closest_pt_on_ray, sphere->center_pos);
    float vec_sphere_to_closest_pt_squared_distance =
        CgmVec3_dot(vec_sphere_to_closest_pt, vec_sphere_to_closest_pt);
    ...
    float distance_to_closest_hit_closest_pt_on_ray = sqrtf(
        sphere_radius_squared - vec_sphere_to_closest_pt_squared_distance);
    CgmVec3 vec_ray_to_closest_pt = CgmVec3_sub(closest_pt_on_ray, ray->pos);
    float vec_ray_to_closest_pt_squared_distance =
        CgmVec3_dot(vec_ray_to_closest_pt, vec_ray_to_closest_pt);

    float distance_to_closest_hit =
        sqrtf(vec_ray_to_closest_pt_squared_distance);
    if (ray_to_sphere_vec_squared_distance > sphere_radius_squared)
...
CgmBool cgm_3d_ray_vs_capsule(CgmRay3d *ray, float ray_max_contact_distance,
                              CgmCapsule3d *capsule,
                              CgmVec3 *contact_normal_out,
                              float *contact_distance_out) {
  CgmVec3 closest_pt_on_ray = CgmRay3d_get_projected_pt(
      ray, ray_max_contact_distance, capsule->center_pos);
  CgmVec3 closest_pt_on_capsule =
      CgmCapsule3d_get_projected_pt(capsule, closest_pt_on_ray);
  CgmSphere sphere = (CgmSphere){.center_pos = closest_pt_on_capsule,
                                 .radius = capsule->radius};
  return cgm_3d_ray_vs_sphere(ray, ray_max_contact_distance, &sphere,
                              contact_normal_out, contact_distance_out);
}

CgmBool cgm_3d_ray_vs_triangle(CgmRay3d *ray, float ray_max_contact_distance,
                               CgmTriangle3d *triangle,
                               CgmVec3 *contact_normal_out,
                               float *contact_distance_out,
                               CgmBool triangle_single_side) {
  ...
  CgmVec3 triangle_face_normal =
      CgmVec3_norm(CgmVec3_mul_cross(edge_axises[0][0], edge_axises[0][1]));
  ...
  CgmVec3 ray_max_contact_distance_pt =
      CgmVec3_mul_scalar(ray->dir, ray_max_contact_distance);
  ...
  for (uint32_t i = 0; i < 5; i += 1) {
    ...
    if (i < 3) {
      ...
      // if the two axis we just cross product together are parallel, we can
      // skip these. this is only because we test the ray direction axis
    ...
    float ray_max_contact_distance_p =
        CgmVec3_dot(ray_max_contact_distance_pt, axis);
    ...
    float triangle_min =
        cgm_min(cgm_min(triangle_p0, triangle_p1), triangle_p2);
    float triangle_max =
        cgm_max(cgm_max(triangle_p0, triangle_p1), triangle_p2);
  ...
  if (contact_normal_out)
    *contact_normal_out = min_axis;
  if (contact_distance_out)
    *contact_distance_out = min_axis_distance;
  return cgm_true;
}

CgmBool cgm_3d_ray_vs_single_side_triangle(CgmRay3d *ray,
                                           float ray_max_contact_distance,
                                           CgmTriangle3d *triangle,
                                           CgmVec3 *contact_normal_out,
                                           float *contact_distance_out) {
  return cgm_3d_ray_vs_triangle(ray, ray_max_contact_distance, triangle,
                                contact_normal_out, contact_distance_out,
                                cgm_true);
}

CgmBool cgm_3d_ray_vs_double_side_triangle(CgmRay3d *ray,
                                           float ray_max_contact_distance,
                                           CgmTriangle3d *triangle,
                                           CgmVec3 *contact_normal_out,
                                           float *contact_distance_out) {
...
CgmBool cgm_3d_ray_vs_mesh(CgmRay3d *ray, float ray_max_contact_distance,
                           CgmMesh *mesh, CgmVec3 *contact_normal_out,
                           float *contact_distance_out) {
  CgmTriangle3d triangle;
  ...
  for (uint32_t i = 0; i < mesh->triangles_count; i += 1) {
    ...
    if (cgm_3d_ray_vs_triangle(ray, ray_max_contact_distance, &triangle,
                               &contact_normal, &contact_distance, cgm_true)) {
      if (!contact_normal_out && !contact_distance_out)
        return cgm_true;
  ...
  if (isinf(min_contact_distance))
    return cgm_false;

  if (contact_normal_out)
    *contact_normal_out = best_contact_normal;
  if (contact_distance_out)
    *contact_distance_out = contact_distance;
  return cgm_true;
}

CgmBool cgm_3d_aabb_vs_pt(CgmAabb3d *aabb, CgmVec3 pt,
                          CgmVec3 *contact_normal_out,
                          float *contact_distance_out) {
  CgmBool res =
      cgm_3d_pt_vs_aabb(pt, aabb, contact_normal_out, contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
  }
  return res;
}

CgmBool cgm_3d_aabb_vs_aabb(CgmAabb3d *a, CgmAabb3d *b,
                            CgmVec3 *contact_normal_out,
                            float *contact_distance_out) {
  CgmAabb3d tmp = *b;
  ...
  return cgm_3d_aabb_vs_pt(&tmp, CgmAabb3d_center(a), contact_normal_out,
                           contact_distance_out);
}

CgmBool cgm_3d_aabb_vs_sphere(CgmAabb3d *aabb, CgmSphere *sphere,
                              CgmVec3 *contact_normal_out,
                              float *contact_distance_out) {
  if (cgm_3d_aabb_vs_pt(aabb, sphere->center_pos, NULL, NULL)) {
    ...
    // determine the closest edge to get the normal and distance from that edge.
    //
    CgmVec3 vec_to_sphere =
        CgmVec3_sub(sphere->center_pos, CgmAabb3d_center(aabb));
    ...
    if (contact_distance_out)
      *contact_distance_out = sphere->radius + distance_to_edge;
    if (contact_normal_out)
      *contact_normal_out = normal;
    return cgm_true;
  } else {
    ...
    if (distance_squared <= radius_squared) {
      ...
      if (contact_distance_out)
        *contact_distance_out = sphere->radius - distance;
      if (contact_normal_out)
        *contact_normal_out = CgmVec3_mul_scalar(vec, -(1.f / distance));
      return cgm_true;
    }
  }
  return cgm_false;
...
CgmBool cgm_3d_aabb_vs_swept_sphere(CgmAabb3d *aabb, CgmSphere *sphere,
                                    CgmVec3 sphere_dir,
                                    float sphere_max_contact_distance,
                                    CgmVec3 *contact_normal_out,
                                    float *contact_distance_out) {
  ...
  CgmVec3 capsule_end =
      CgmVec3_add(sphere_rel_pos,
                  CgmVec3_mul_scalar(sphere_dir, sphere_max_contact_distance));
  ...
  CgmVec3 capsule_start_to_closest_aabb_pt_vec = CgmVec3_norm(CgmVec3_sub(
      capsule_start, CgmVec3_clamp(capsule_start, CgmVec3_neg(aabb_half_size),
                                   aabb_half_size)));
  CgmVec3 capsule_end_to_closest_aabb_pt_vec = CgmVec3_norm(CgmVec3_sub(
      capsule_end,
      CgmVec3_clamp(capsule_end, CgmVec3_neg(aabb_half_size), aabb_half_size)));
  ...
  for (uint32_t i = 0; i < 8; i += 1) {
    ...
    if (i < 3) {
      ...
      float squared_distance = CgmVec3_dot(separation_axis, separation_axis);
      // if the two axis we just cross product together are parallel, we can
      // skip these. this is only because the edge axis is also use as a face
      // axis -> u0, u1, u2 and will be tested later.
      if (cgm_approx_eq(squared_distance, 0.f))
        continue;
      axis = CgmVec3_norm(separation_axis);
    } else {
    ...
    // we do not want to store a min travel distance when using an
    // separation axis that is perpendicular. a perpendicular axis
    // means that the swept sphere will be projected in the same place every
    // time.
    ...
    if (offset_along_sphere_dir < min_axis_distance) {
      //
      // we have found a axis with the new minimum separation needed to
      // separate. we need to flip the axis if the capsule is in the positive
      // half of the AABB (AABB center is 0 AKA origin).
      min_axis_distance = distance;
...
CgmBool cgm_3d_aabb_vs_capsule(CgmAabb3d *aabb, CgmCapsule3d *capsule,
                               CgmVec3 *contact_normal_out,
                               float *contact_distance_out) {
  CgmVec3 aabb_center = CgmAabb3d_center(aabb);
  CgmVec3 aabb_half_size = CgmAabb3d_half_size(aabb);
  ...
  CgmVec3 capsule_offset =
      CgmVec3_mul_scalar(capsule->direction, capsule->half_length);
  CgmVec3 capsule_start = CgmVec3_add(capsule_rel_pos, capsule_offset);
  CgmVec3 capsule_end =
      CgmVec3_add(capsule_rel_pos, CgmVec3_neg(capsule_offset));
...
CgmBool cgm_3d_aabb_vs_triangle(CgmAabb3d *aabb, CgmTriangle3d *triangle,
                                CgmVec3 *contact_normal_out,
                                float *contact_distance_out,
                                CgmBool triangle_single_side) {
  CgmVec3 aabb_center = CgmAabb3d_center(aabb);
  ...
  // separation axis
  CgmVec3 edge_axises[][2] = {
      {u0, e0}, {u0, e1}, {u0, e2}, {u1, e0}, {u1, e1},
      {u1, e2}, {u2, e0}, {u2, e1}, {u2, e2},
  };
  ...
  for (uint32_t i = 0; i < 13; i += 1) {
    ...
    if (distance < min_axis_distance) {
      //
      // we have found a axis with the new minimum separation needed to
      // separate. we need to flip the axis if the triangle is in the positive
      // half of the AABB (AABB center is 0 AKA origin).
      min_axis_distance = distance;
      min_axis = min + ((max - min) * 0.5f) > 0.f ? CgmVec3_neg(axis) : axis;
      ;
...
CgmBool cgm_3d_aabb_vs_single_side_triangle(CgmAabb3d *aabb,
                                            CgmTriangle3d *triangle,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  return cgm_3d_aabb_vs_triangle(aabb, triangle, contact_normal_out,
                                 contact_distance_out, cgm_true);
}

CgmBool cgm_3d_aabb_vs_double_side_triangle(CgmAabb3d *aabb,
                                            CgmTriangle3d *triangle,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  return cgm_3d_aabb_vs_triangle(aabb, triangle, contact_normal_out,
                                 contact_distance_out, cgm_false);
}

static inline CgmBool _cgm_3d_shape_vs_mesh(void *shape, CgmMesh *mesh,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out,
                                            CgmBool (*fn)()) {
  CgmTriangle3d triangle;
...
CgmBool cgm_3d_aabb_vs_mesh(CgmAabb3d *aabb, CgmMesh *mesh,
                            CgmVec3 *contact_normal_out,
                            float *contact_distance_out) {
  return _cgm_3d_shape_vs_mesh(aabb, mesh, contact_normal_out,
                               contact_distance_out,
                               (CgmBool(*)())cgm_3d_aabb_vs_triangle);
}

CgmBool cgm_3d_aabb_vs_hoop(CgmAabb3d *aabb, CgmHoop3d *hoop,
                            CgmVec3 *contact_normal_out,
                            float *contact_distance_out) {
  CgmVec3 closest_pt_on_aabb = CgmAabb3d_closest_pt(aabb, hoop->center_pos);
  CgmVec3 aabb_half_size = CgmAabb3d_half_size(aabb);
  float max_half_size =
      cgm_max(cgm_max(aabb_half_size.x, aabb_half_size.y), aabb_half_size.z);
  if (cgm_3d_aabb_vs_pt(aabb, hoop->center_pos, NULL, NULL) &&
      max_half_size > hoop->inner_radius) {
    //
    ...
    CgmVec3 closest_pt_on_hoop =
        CgmHoop3d_closest_pt(hoop, CgmAabb3d_center(aabb));
    CgmVec3 vec_to_closest_pt_on_hoop =
        CgmVec3_sub(closest_pt_on_hoop, hoop->center_pos);

    if (vec_to_closest_pt_on_hoop.x > vec_to_closest_pt_on_hoop.y &&
        vec_to_closest_pt_on_hoop.x > vec_to_closest_pt_on_hoop.z) {
      normal =
          CgmVec3_init(copysignf(1.f, -vec_to_closest_pt_on_hoop.x), 0.f, 0.f);
      distance_to_edge = aabb_half_size.x - vec_to_closest_pt_on_hoop.x;
    } else if (vec_to_closest_pt_on_hoop.y > vec_to_closest_pt_on_hoop.x &&
               vec_to_closest_pt_on_hoop.y > vec_to_closest_pt_on_hoop.z) {
      normal =
          CgmVec3_init(0.f, copysignf(1.f, -vec_to_closest_pt_on_hoop.y), 0.f);
      distance_to_edge = aabb_half_size.y - vec_to_closest_pt_on_hoop.y;
    } else {
      normal =
          CgmVec3_init(0.f, 0.f, copysignf(1.f, -vec_to_closest_pt_on_hoop.z));
      distance_to_edge = aabb_half_size.z - vec_to_closest_pt_on_hoop.z;
    }

    if (contact_distance_out)
      *contact_distance_out = hoop->rim_radius + distance_to_edge;
    if (contact_normal_out)
      *contact_normal_out = normal;
    return cgm_true;
  } else {
    ...
    CgmVec3 another_closest_pt_on_aabb =
        CgmAabb3d_clamp_pt(aabb, closest_pt_on_hoop);
    CgmVec3 closest_pt_on_hoop_to_aabb_vec =
        CgmVec3_sub(another_closest_pt_on_aabb, closest_pt_on_hoop);
    if (CgmVec3_dot(closest_pt_on_hoop_to_aabb_vec, vec_to_closest_pt_on_hoop) <
        0.f) {
      //
      // now check each vertex and see if there is a closer point around the
      // ring
      CgmVec3 vertices[] = {
      ...
      float min_distance_squared = CgmVec3_dot(closest_pt_on_hoop_to_aabb_vec,
                                               closest_pt_on_hoop_to_aabb_vec);
      ;
      for (uint32_t i = 0; i < 8; i += 1) {
        CgmVec3 vertex = vertices[i];
        CgmVec3 vertex_closest_pt_on_hoop = CgmHoop3d_closest_pt(hoop, vertex);

        CgmVec3 vertex_another_closest_pt_on_aabb =
            CgmAabb3d_clamp_pt(aabb, vertex_closest_pt_on_hoop);
        CgmVec3 vec_to_aabb_from_closest_pt = CgmVec3_sub(
            vertex_another_closest_pt_on_aabb, vertex_closest_pt_on_hoop);
        float len_squared_to_aabb_from_closest_pt = CgmVec3_dot(
            vec_to_aabb_from_closest_pt, vec_to_aabb_from_closest_pt);
    ...
    // now just do make a sphere using the closest point to test against the
    // AABB.
    CgmSphere sphere = {.center_pos = closest_pt_on_hoop,
                        .radius = hoop->rim_radius};
    return cgm_3d_aabb_vs_sphere(aabb, &sphere, contact_normal_out,
                                 contact_distance_out);
  }
  return cgm_false;
}

CgmBool cgm_3d_sphere_vs_pt(CgmSphere *sphere, CgmVec3 pt,
                            CgmVec3 *contact_normal_out,
                            float *contact_distance_out) {
  CgmBool res =
      cgm_3d_pt_vs_sphere(pt, sphere, contact_normal_out, contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
  }
...
CgmBool cgm_3d_sphere_vs_sphere(CgmSphere *a, CgmSphere *b,
                                CgmVec3 *contact_normal_out,
                                float *contact_distance_out) {
  CgmSphere tmp = {.radius = a->radius + b->radius,
                   .center_pos = b->center_pos};
  return cgm_3d_pt_vs_sphere(a->center_pos, &tmp, contact_normal_out,
                             contact_distance_out);
}

CgmBool cgm_3d_sphere_vs_aabb(CgmSphere *sphere, CgmAabb3d *aabb,
                              CgmVec3 *contact_normal_out,
                              float *contact_distance_out) {
  CgmBool res = cgm_3d_aabb_vs_sphere(aabb, sphere, contact_normal_out,
                                      contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_swept_sphere_vs_aabb(CgmSphere *sphere, CgmVec3 sphere_dir,
                                    float sphere_max_contact_distance,
                                    CgmAabb3d *aabb,
                                    CgmVec3 *contact_normal_out,
                                    float *contact_distance_out) {
  CgmBool res = cgm_3d_aabb_vs_swept_sphere(
      aabb, sphere, sphere_dir, sphere_max_contact_distance, contact_normal_out,
      contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_sphere_vs_capsule(CgmSphere *sphere, CgmCapsule3d *capsule,
                                 CgmVec3 *contact_normal_out,
                                 float *contact_distance_out) {
  CgmVec3 projected_pt =
      CgmCapsule3d_get_projected_pt(capsule, sphere->center_pos);
  CgmSphere tmp = {.radius = capsule->radius, .center_pos = projected_pt};
  return cgm_3d_sphere_vs_sphere(sphere, &tmp, contact_normal_out,
                                 contact_distance_out);
}

CgmBool cgm_3d_sphere_vs_triangle(CgmSphere *sphere, CgmTriangle3d *triangle,
                                  CgmVec3 *contact_normal_out,
                                  float *contact_distance_out,
                                  CgmBool triangle_single_side) {
  // translate triangle into relative space from the AABB center.
  ...
  for (uint32_t i = 0; i < 4; i += 1) {
    ...
    if (distance < min_axis_distance) {
      ...
      // we have found a axis with the new minimum separation needed to
      // separate. we need to flip the axis if the triangle is in the positive
      // half of the sphere (sphere center is 0 AKA origin).
      min_axis_distance = distance;
      min_axis = min + ((max - min) * 0.5f) > 0.f ? CgmVec3_neg(axis) : axis;
    }
  }
...
CgmBool cgm_3d_sphere_vs_single_side_triangle(CgmSphere *sphere,
                                              CgmTriangle3d *triangle,
                                              CgmVec3 *contact_normal_out,
                                              float *contact_distance_out) {
  return cgm_3d_sphere_vs_triangle(sphere, triangle, contact_normal_out,
                                   contact_distance_out, cgm_true);
}

CgmBool cgm_3d_sphere_vs_double_side_triangle(CgmSphere *sphere,
                                              CgmTriangle3d *triangle,
                                              CgmVec3 *contact_normal_out,
                                              float *contact_distance_out) {
  return cgm_3d_sphere_vs_triangle(sphere, triangle, contact_normal_out,
...
CgmBool cgm_3d_sphere_vs_mesh(CgmSphere *sphere, CgmMesh *mesh,
                              CgmVec3 *contact_normal_out,
                              float *contact_distance_out) {
  return _cgm_3d_shape_vs_mesh(sphere, mesh, contact_normal_out,
                               contact_distance_out,
                               (CgmBool(*)())cgm_3d_sphere_vs_triangle);
}

CgmBool cgm_3d_sphere_vs_hoop(CgmSphere *sphere, CgmHoop3d *hoop,
                              CgmVec3 *contact_normal_out,
                              float *contact_distance_out) {
  CgmVec3 closest_pt_on_hoop = CgmHoop3d_closest_pt(hoop, sphere->center_pos);
  CgmVec3 vec_to_closest_pt_on_hoop =
      CgmVec3_sub(closest_pt_on_hoop, sphere->center_pos);

  //
  // now we have found the closest point on the hoop to the sphere.
  // now just do make a sphere using the closest point to test against the
  // sphere.
  CgmSphere hoop_closest_sphere = {.center_pos = closest_pt_on_hoop,
                                   .radius = hoop->rim_radius};
  return cgm_3d_sphere_vs_sphere(sphere, &hoop_closest_sphere,
                                 contact_normal_out, contact_distance_out);
}

CgmBool cgm_3d_capsule_vs_pt(CgmCapsule3d *capsule, CgmVec3 pt,
                             CgmVec3 *contact_normal_out,
                             float *contact_distance_out) {
  CgmBool res = cgm_3d_pt_vs_capsule(pt, capsule, contact_normal_out,
                                     contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_capsule_vs_capsule(CgmCapsule3d *a, CgmCapsule3d *b,
                                  CgmVec3 *contact_normal_out,
                                  float *contact_distance_out) {
  //
  ...
  for (uint32_t i = 0; i < 4; i += 1) {
    ...
    if (i < 1) {
      ...
      float squared_distance = CgmVec3_dot(separation_axis, separation_axis);
      // if the two axis we just cross product together are parallel, we can
      // skip these. this is only because we calculated the
      // closest_end_to_projected_pt_vec which will handle the separation that
      // this cross product was trying to do.
      if (cgm_approx_eq(squared_distance, 0.f))
        continue;
      axis = CgmVec3_norm(separation_axis);
    } else {
    ...
    // the smaller is the possible separation or overlap between  the two
    // shapes. the larger one will be the span of the two shapes across the
    // axis.
    ...
    if (distance < min_axis_distance) {
      //
      // we have found a axis with the new minimum separation needed to
      // separate. we need to flip the axis if the capsule B is past capsule A
      min_axis_distance = distance;
      min_axis =
          a_min + ((a_max - a_min) * 0.5f) < b_min + ((b_max - b_min) * 0.5f)
              ? CgmVec3_neg(axis)
              : axis;
    }
  }
...
CgmBool cgm_3d_capsule_vs_aabb(CgmCapsule3d *capsule, CgmAabb3d *aabb,
                               CgmVec3 *contact_normal_out,
                               float *contact_distance_out) {
  CgmBool res = cgm_3d_aabb_vs_capsule(aabb, capsule, contact_normal_out,
                                       contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_capsule_vs_sphere(CgmCapsule3d *capsule, CgmSphere *sphere,
                                 CgmVec3 *contact_normal_out,
                                 float *contact_distance_out) {
  CgmBool res = cgm_3d_sphere_vs_capsule(sphere, capsule, contact_normal_out,
                                         contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_capsule_vs_triangle(CgmCapsule3d *capsule,
                                   CgmTriangle3d *triangle,
                                   CgmVec3 *contact_normal_out,
                                   float *contact_distance_out,
                                   CgmBool triangle_single_side) {
  ...
  CgmVec3 capsule_end =
      CgmVec3_add(capsule->center_pos, CgmVec3_neg(capsule_offset));
  CgmVec3 capsule_edge_vector = CgmVec3_sub(capsule_end, capsule_start);
  ...
  // subtracting these two points will give us the separation axis vector we
  // need.
  ...
  for (uint32_t i = 0; i < 3; i += 1) {
    ...
    float t = CgmVec3_dot(CgmVec3_sub(capsule_start, start), edge) /
              edge_distance_squared;
    CgmVec3 projected_pt_start =
        CgmVec3_add(start, CgmVec3_mul_scalar(edge, cgm_clamp(t, 0.f, 1.f)));

    // project capsule_end onto the triangle edge
    t = CgmVec3_dot(CgmVec3_sub(capsule_end, start), edge) /
        edge_distance_squared;
    CgmVec3 projected_pt_end =
        CgmVec3_add(start, CgmVec3_mul_scalar(edge, cgm_clamp(t, 0.f, 1.f)));

    // reproject from the points back onto the capsule
    CgmVec3 reprojected_pt_on_capsule_start =
        CgmCapsule3d_get_projected_pt(capsule, projected_pt_start);
    CgmVec3 reprojected_pt_on_capsule_end =
        CgmCapsule3d_get_projected_pt(capsule, projected_pt_end);

    // create the separation axis
    face_axises[1 + i * 2] = CgmVec3_norm(
        CgmVec3_sub(projected_pt_start, reprojected_pt_on_capsule_start));
    face_axises[1 + i * 2 + 1] = CgmVec3_norm(
        CgmVec3_sub(projected_pt_end, reprojected_pt_on_capsule_end));
  }

  CgmVec3 triangle_face_normal = CgmVec3_norm(
      CgmVec3_mul_cross(triangle_edge_vecs[0], triangle_edge_vecs[1]));
  ...
  for (uint32_t i = 0; i < 9; i += 1) {
    ...
    if (i < 3) {
      ...
      float squared_distance = CgmVec3_dot(separation_axis, separation_axis);
      // if the two axis we just cross product together are parallel, we can
      // skip these. this is only because we test the projected start and end
      // points of the capsule on each triangle edge.
      if (cgm_approx_eq(squared_distance, 0.f))
        continue;
      axis = CgmVec3_norm(separation_axis);
    } else {
    ...
    float capsule_min =
        cgm_min(capsule_p_start, capsule_p_end) - capsule->radius;
    float capsule_max =
        cgm_max(capsule_p_start, capsule_p_end) + capsule->radius;
    ...
    float distance =
        cgm_min(capsule_max - triangle_min, triangle_max - capsule_min);
    if (distance < 0.f) {
      //
      // here we have found a separation along this axis
      // so return no collision.
    ...
    if (distance < min_axis_distance) {
      ...
      // side of the capsule.
      min_axis_distance = distance;
      min_axis = capsule_min + ((capsule_max - capsule_min) * 0.5f) <
                         triangle_min + ((triangle_max - triangle_min) * 0.5f)
                     ? CgmVec3_neg(axis)
                     : axis;
    }
  }
...
CgmBool cgm_3d_capsule_vs_single_side_triangle(CgmCapsule3d *capsule,
                                               CgmTriangle3d *triangle,
                                               CgmVec3 *contact_normal_out,
                                               float *contact_distance_out) {
  return cgm_3d_capsule_vs_triangle(capsule, triangle, contact_normal_out,
                                    contact_distance_out, cgm_true);
}

CgmBool cgm_3d_capsule_vs_double_side_triangle(CgmCapsule3d *capsule,
                                               CgmTriangle3d *triangle,
                                               CgmVec3 *contact_normal_out,
                                               float *contact_distance_out) {
  return cgm_3d_capsule_vs_triangle(capsule, triangle, contact_normal_out,
...
CgmBool cgm_3d_capsule_vs_mesh(CgmCapsule3d *capsule, CgmMesh *mesh,
                               CgmVec3 *contact_normal_out,
                               float *contact_distance_out) {
  return _cgm_3d_shape_vs_mesh(capsule, mesh, contact_normal_out,
                               contact_distance_out,
                               (CgmBool(*)())cgm_3d_capsule_vs_triangle);
}

CgmBool cgm_3d_capsule_vs_hoop(CgmCapsule3d *capsule, CgmHoop3d *hoop,
                               CgmVec3 *contact_normal_out,
                               float *contact_distance_out) {
  float hoop_center_to_rim_center_offset =
      hoop->inner_radius + hoop->rim_radius;
  float hoop_center_offset_p = CgmVec3_dot(
      CgmVec3_sub(hoop->center_pos, capsule->center_pos), capsule->direction);
  float up_p = fabsf(CgmVec3_dot(hoop->up, capsule->direction) *
                     hoop_center_to_rim_center_offset);
  float right_p = fabsf(CgmVec3_dot(hoop->right, capsule->direction) *
                        hoop_center_to_rim_center_offset);

  float offsets[5] = {
      up_p, right_p, -up_p, -right_p, 0.f,
  };
  ...
  CgmVec3 closest_pt_on_capsule;
  for (int i = 0; i < 5; i += 1) {
    float pt_p = cgm_clamp(hoop_center_offset_p + offsets[i],
                           -capsule->half_length, capsule->half_length);
    CgmVec3 pt_on_capsule = CgmVec3_add(
        capsule->center_pos, CgmVec3_mul_scalar(capsule->direction, pt_p));
  ...
  CgmSphere hoop_closest_sphere = {.center_pos = closest_pt_on_hoop,
                                   .radius = hoop->rim_radius};
  if (cgm_3d_pt_vs_sphere(closest_pt_on_capsule, &hoop_closest_sphere, NULL,
                          NULL)) {
    if (!contact_normal_out && !contact_distance_out)
      return cgm_true;
    ...
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_norm(vec);
    if (contact_distance_out)
      *contact_distance_out = hoop->rim_radius - vec_len + capsule->radius;
    return cgm_true;
  }

  CgmSphere capsule_closest_sphere = {.center_pos = closest_pt_on_capsule,
                                      .radius = capsule->radius};
  if (cgm_3d_sphere_vs_sphere(&capsule_closest_sphere, &hoop_closest_sphere,
                              contact_normal_out, contact_distance_out)) {
    return cgm_true;
    /* TODO: if the capsule spans over both ends of the hoop horizontally and
    vertically (face normal)
    ...
    CgmVec3 capsule_offset = CgmVec3_mul_scalar(capsule->direction,
    capsule->half_length); CgmVec3 capsule_rel_pos =
    CgmVec3_sub(capsule->center_pos, hoop->center_pos); CgmVec3 capsule_start =
    CgmVec3_add(capsule_rel_pos, capsule_offset); CgmVec3 capsule_end =
    CgmVec3_add(capsule_rel_pos, CgmVec3_neg(capsule_offset));

    CgmVec3 max_capsule_span_vec = CgmVec3_mul_scalar(capsule->direction,
    hoop_center_to_rim_center_p);

    CgmVec3 hoop_face_normal = CgmVec3_norm(CgmVec3_mul_cross(hoop->up,
    hoop->right));

    float max_capsule_span_p = CgmVec3_dot(max_capsule_span_vec,
    hoop_face_normal);
    ...
    float capsule_min = cgm_min(capped_capsule_p_start, capped_capsule_p_end) -
    capsule->radius; float capsule_max = cgm_max(capped_capsule_p_start,
    capped_capsule_p_end) + capsule->radius;
    ...
    if (capsule_min < hoop->rim_radius && capsule_max > hoop->rim_radius) {
            if (capped_capsule_max > -capped_capsule_min) {
                    if (contact_normal_out) *contact_normal_out =
    hoop_face_normal; if (contact_distance_out) *contact_distance_out =
    hoop->rim_radius - capped_capsule_min; } else { if (contact_normal_out)
    *contact_normal_out = CgmVec3_neg(hoop_face_normal); if
    (contact_distance_out) *contact_distance_out = hoop->rim_radius +
    capped_capsule_max;
            }
    }
...
CgmBool cgm_3d_triangle_vs_aabb(CgmTriangle3d *triangle, CgmAabb3d *aabb,
                                CgmVec3 *contact_normal_out,
                                float *contact_distance_out,
                                CgmBool triangle_single_side) {
  CgmBool res =
      cgm_3d_aabb_vs_triangle(aabb, triangle, contact_normal_out,
                              contact_distance_out, triangle_single_side);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
  }
...
CgmBool cgm_3d_triangle_vs_sphere(CgmTriangle3d *triangle, CgmSphere *sphere,
                                  CgmVec3 *contact_normal_out,
                                  float *contact_distance_out,
                                  CgmBool triangle_single_side) {
  CgmBool res =
      cgm_3d_sphere_vs_triangle(sphere, triangle, contact_normal_out,
                                contact_distance_out, triangle_single_side);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_triangle_vs_capsule(CgmTriangle3d *triangle,
                                   CgmCapsule3d *capsule,
                                   CgmVec3 *contact_normal_out,
                                   float *contact_distance_out,
                                   CgmBool triangle_single_side) {
  CgmBool res =
      cgm_3d_capsule_vs_triangle(capsule, triangle, contact_normal_out,
                                 contact_distance_out, triangle_single_side);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_triangle_vs_triangle(CgmTriangle3d *a, CgmTriangle3d *b,
                                    CgmVec3 *contact_normal_out,
                                    float *contact_distance_out,
                                    CgmBool triangle_single_side_a,
                                    CgmBool triangle_single_side_b) {
  //
  ...
  // separation axis
  CgmVec3 edge_axises[][2] = {
      {a_e0, b_e0}, {a_e0, b_e1}, {a_e0, b_e2},

      {a_e1, b_e0}, {a_e1, b_e1}, {a_e1, b_e2},

      {a_e2, b_e0}, {a_e2, b_e1}, {a_e2, b_e2},
  };
  ...
  for (uint32_t i = 0; i < 11; i += 1) {
    ...
    if (i < 9) {
      ...
      CgmVec3 separation_axis = CgmVec3_mul_cross(axis, edge_axises[i][1]);
      float squared_distance = CgmVec3_dot(separation_axis, separation_axis);
      // if the two axis we just cross product together are parallel, we need to
      // find a perpendicular axis to test these two edges. we do this by first
      // projecting the triangle A edge start point onto the triangle B edge.
      // this will give us the closest point on the triangle B edge to the
      // triangle A start point. we then use this new projected point to find
      // the closest point back on the triangle A edge using the same technique.
      // subtracting these two points give us for the separation axis vector we
      // need.
      if (cgm_approx_eq(squared_distance, 0.f)) {
        uint32_t a_i = i / 3;
        uint32_t b_i = i % 3;
        ...
        CgmVec3 projected_pt_a_onto_b =
            cgm_line_get_projected_pt(b_start, b_end, a_start);
        CgmVec3 reprojected_pt_b_onto_a =
            cgm_line_get_projected_pt(a_start, a_end, projected_pt_a_onto_b);

        separation_axis =
            CgmVec3_sub(projected_pt_a_onto_b, reprojected_pt_b_onto_a);
      }
      axis = CgmVec3_norm(separation_axis);
    } else {
      axis = face_axises[i - 9];
...
CgmBool cgm_3d_triangle_vs_mesh(CgmTriangle3d *triangle, CgmMesh *mesh,
                                CgmVec3 *contact_normal_out,
                                float *contact_distance_out,
                                CgmBool triangle_single_side) {
  ...
  for (uint32_t i = 0; i < mesh->triangles_count; i += 1) {
    ...
    if (cgm_3d_triangle_vs_triangle(triangle, &mesh_triangle, &contact_normal,
                                    &contact_distance, triangle_single_side,
                                    cgm_true)) {
      if (!contact_normal_out && !contact_distance_out)
        return cgm_true;
...
CgmBool cgm_3d_triangle_vs_hoop(CgmTriangle3d *triangle, CgmHoop3d *hoop,
                                CgmVec3 *contact_normal_out,
                                float *contact_distance_out,
                                CgmBool triangle_single_side) {
  ...
  CgmVec3 rim_vec =
      CgmVec3_mul_scalar(hoop_face_normal, hoop->rim_radius * 2.f);
  ...
  for (uint32_t i = 0; i < 5; i += 1) {
    ...
    float inner_size =
        hoop->inner_radius * fabsf(CgmVec3_dot(hoop->up, axis)) +
    ...
    if (distance < min_axis_distance) {
      //
      // we have found a axis with the new minimum separation needed to
      // separate. we need to flip the axis if the triangle is on the side of
      // the rim
      min_axis_distance = distance;
      min_axis = triangle_min + ((triangle_max - triangle_min) * 0.5f) <
                         rim_min + ((rim_max - rim_min) * 0.5f)
                     ? CgmVec3_neg(axis)
                     : axis;
    }
  }
...
CgmBool cgm_3d_single_side_triangle_vs_aabb(CgmTriangle3d *triangle,
                                            CgmAabb3d *aabb,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  return cgm_3d_triangle_vs_aabb(triangle, aabb, contact_normal_out,
                                 contact_distance_out, cgm_true);
}

CgmBool cgm_3d_single_side_triangle_vs_sphere(CgmTriangle3d *triangle,
                                              CgmSphere *sphere,
                                              CgmVec3 *contact_normal_out,
                                              float *contact_distance_out) {
  return cgm_3d_triangle_vs_sphere(triangle, sphere, contact_normal_out,
                                   contact_distance_out, cgm_true);
}

CgmBool cgm_3d_single_side_triangle_vs_capsule(CgmTriangle3d *triangle,
                                               CgmCapsule3d *capsule,
                                               CgmVec3 *contact_normal_out,
                                               float *contact_distance_out) {
  return cgm_3d_triangle_vs_capsule(triangle, capsule, contact_normal_out,
                                    contact_distance_out, cgm_true);
}

CgmBool cgm_3d_single_side_triangle_vs_single_side_triangle(
    CgmTriangle3d *a, CgmTriangle3d *b, CgmVec3 *contact_normal_out,
    float *contact_distance_out) {
  return cgm_3d_triangle_vs_triangle(a, b, contact_normal_out,
                                     contact_distance_out, cgm_true, cgm_true);
}

CgmBool cgm_3d_single_side_triangle_vs_double_side_triangle(
    CgmTriangle3d *a, CgmTriangle3d *b, CgmVec3 *contact_normal_out,
    float *contact_distance_out) {
  return cgm_3d_triangle_vs_triangle(a, b, contact_normal_out,
                                     contact_distance_out, cgm_true, cgm_false);
}

CgmBool cgm_3d_single_side_triangle_vs_mesh(CgmTriangle3d *triangle,
                                            CgmMesh *mesh,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  return cgm_3d_triangle_vs_mesh(triangle, mesh, contact_normal_out,
                                 contact_distance_out, cgm_true);
}

CgmBool cgm_3d_single_side_triangle_vs_hoop(CgmTriangle3d *triangle,
                                            CgmHoop3d *hoop,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  return cgm_3d_triangle_vs_hoop(triangle, hoop, contact_normal_out,
                                 contact_distance_out, cgm_true);
}

CgmBool cgm_3d_double_side_triangle_vs_aabb(CgmTriangle3d *triangle,
                                            CgmAabb3d *aabb,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  return cgm_3d_triangle_vs_aabb(triangle, aabb, contact_normal_out,
...
CgmBool cgm_3d_double_side_triangle_vs_sphere(CgmTriangle3d *triangle,
                                              CgmSphere *sphere,
                                              CgmVec3 *contact_normal_out,
                                              float *contact_distance_out) {
  return cgm_3d_triangle_vs_sphere(triangle, sphere, contact_normal_out,
...
CgmBool cgm_3d_double_side_triangle_vs_capsule(CgmTriangle3d *triangle,
                                               CgmCapsule3d *capsule,
                                               CgmVec3 *contact_normal_out,
                                               float *contact_distance_out) {
  return cgm_3d_triangle_vs_capsule(triangle, capsule, contact_normal_out,
...
CgmBool cgm_3d_double_side_triangle_vs_single_side_triangle(
    CgmTriangle3d *a, CgmTriangle3d *b, CgmVec3 *contact_normal_out,
    float *contact_distance_out) {
  return cgm_3d_triangle_vs_triangle(a, b, contact_normal_out,
                                     contact_distance_out, cgm_false, cgm_true);
}

CgmBool cgm_3d_double_side_triangle_vs_double_side_triangle(
    CgmTriangle3d *a, CgmTriangle3d *b, CgmVec3 *contact_normal_out,
    float *contact_distance_out) {
  return cgm_3d_triangle_vs_triangle(
      a, b, contact_normal_out, contact_distance_out, cgm_false, cgm_false);
}

CgmBool cgm_3d_double_side_triangle_vs_mesh(CgmTriangle3d *triangle,
                                            CgmMesh *mesh,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  return cgm_3d_triangle_vs_mesh(triangle, mesh, contact_normal_out,
...
CgmBool cgm_3d_double_side_triangle_vs_hoop(CgmTriangle3d *triangle,
                                            CgmHoop3d *hoop,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  return cgm_3d_triangle_vs_hoop(triangle, hoop, contact_normal_out,
...
CgmBool cgm_3d_mesh_vs_aabb(CgmMesh *mesh, CgmAabb3d *aabb,
                            CgmVec3 *contact_normal_out,
                            float *contact_distance_out) {
  CgmBool res =
      cgm_3d_aabb_vs_mesh(aabb, mesh, contact_normal_out, contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
  }
...
CgmBool cgm_3d_mesh_vs_sphere(CgmMesh *mesh, CgmSphere *sphere,
                              CgmVec3 *contact_normal_out,
                              float *contact_distance_out) {
  CgmBool res = cgm_3d_sphere_vs_mesh(sphere, mesh, contact_normal_out,
                                      contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_mesh_vs_capsule(CgmMesh *mesh, CgmCapsule3d *capsule,
                               CgmVec3 *contact_normal_out,
                               float *contact_distance_out) {
  CgmBool res = cgm_3d_capsule_vs_mesh(capsule, mesh, contact_normal_out,
                                       contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_mesh_vs_triangle(CgmMesh *mesh, CgmTriangle3d *triangle,
                                CgmVec3 *contact_normal_out,
                                float *contact_distance_out,
                                CgmBool triangle_single_side) {
  CgmBool res =
      cgm_3d_triangle_vs_mesh(triangle, mesh, contact_normal_out,
                              contact_distance_out, triangle_single_side);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_mesh_vs_hoop(CgmMesh *mesh, CgmHoop3d *hoop,
                            CgmVec3 *contact_normal_out,
                            float *contact_distance_out) {
  CgmBool res = _cgm_3d_shape_vs_mesh(hoop, mesh, contact_normal_out,
                                      contact_distance_out,
                                      (CgmBool(*)())cgm_3d_hoop_vs_triangle);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
  }
...
CgmBool cgm_3d_mesh_vs_single_side_triangle(CgmMesh *mesh,
                                            CgmTriangle3d *triangle,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  return cgm_3d_mesh_vs_triangle(mesh, triangle, contact_normal_out,
                                 contact_distance_out, cgm_true);
}

CgmBool cgm_3d_mesh_vs_double_side_triangle(CgmMesh *mesh,
                                            CgmTriangle3d *triangle,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  return cgm_3d_mesh_vs_triangle(mesh, triangle, contact_normal_out,
...
CgmBool cgm_3d_hoop_vs_aabb(CgmHoop3d *hoop, CgmAabb3d *aabb,
                            CgmVec3 *contact_normal_out,
                            float *contact_distance_out) {
  CgmBool res =
      cgm_3d_aabb_vs_hoop(aabb, hoop, contact_normal_out, contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
  }
...
CgmBool cgm_3d_hoop_vs_sphere(CgmHoop3d *hoop, CgmSphere *sphere,
                              CgmVec3 *contact_normal_out,
                              float *contact_distance_out) {
  CgmBool res = cgm_3d_sphere_vs_hoop(sphere, hoop, contact_normal_out,
                                      contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_hoop_vs_capsule(CgmHoop3d *hoop, CgmCapsule3d *capsule,
                               CgmVec3 *contact_normal_out,
                               float *contact_distance_out) {
  CgmBool res = cgm_3d_capsule_vs_hoop(capsule, hoop, contact_normal_out,
                                       contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_hoop_vs_triangle(CgmHoop3d *hoop, CgmTriangle3d *triangle,
                                CgmVec3 *contact_normal_out,
                                float *contact_distance_out,
                                CgmBool triangle_single_side) {
  CgmBool res =
      cgm_3d_triangle_vs_hoop(triangle, hoop, contact_normal_out,
                              contact_distance_out, triangle_single_side);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_hoop_vs_single_side_triangle(CgmHoop3d *hoop,
                                            CgmTriangle3d *triangle,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  CgmBool res = cgm_3d_single_side_triangle_vs_hoop(
      triangle, hoop, contact_normal_out, contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
  }
...
CgmBool cgm_3d_hoop_vs_double_side_triangle(CgmHoop3d *hoop,
                                            CgmTriangle3d *triangle,
                                            CgmVec3 *contact_normal_out,
                                            float *contact_distance_out) {
  CgmBool res = cgm_3d_double_side_triangle_vs_hoop(
      triangle, hoop, contact_normal_out, contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
...
CgmBool cgm_3d_hoop_vs_mesh(CgmHoop3d *hoop, CgmMesh *mesh,
                            CgmVec3 *contact_normal_out,
                            float *contact_distance_out) {
  CgmBool res =
      cgm_3d_mesh_vs_hoop(mesh, hoop, contact_normal_out, contact_distance_out);
  if (res) {
    if (contact_normal_out)
      *contact_normal_out = CgmVec3_neg(*contact_normal_out);
  }
...
CgmBool cgm_3d_hoop_vs_hoop(CgmHoop3d *a, CgmHoop3d *b,
                            CgmVec3 *contact_normal_out,
                            float *contact_distance_out) {
  CgmVec3 closest_pt_on_a = CgmHoop3d_closest_pt(a, b->center_pos);
  CgmVec3 closest_pt_on_b = CgmHoop3d_closest_pt(b, a->center_pos);

  CgmSphere a_closest_sphere = {.radius = a->rim_radius,
                                .center_pos = closest_pt_on_a};
  CgmSphere b_closest_sphere = {.radius = b->rim_radius,
                                .center_pos = closest_pt_on_b};
  return cgm_3d_sphere_vs_sphere(&a_closest_sphere, &b_closest_sphere,
                                 contact_normal_out, contact_distance_out);
}
